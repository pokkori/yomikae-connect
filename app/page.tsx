  ...
  return (
    <div className="min-h-dvh flex flex-col items-center justify-center px-4 py-12"
      ...
      <div className="text-center mb-8">
        <div className="text-8xl mb-4" style={{ filter: "drop-shadow(0 0 20px rgba(245,158,11,0.5))" }}>📖</div>
      ...
      <div className="w-full max-w-sm space-y-3">
        {[
          { icon: "🔤", title: "16文字を4グループに分類", desc: "音読み・訓読み・部首・関連語でグループ分け" },
          { icon: "💡", title: "ヒントあり", desc: "各グループには「何で繋がっているか」のヒントが隠れている" },
          { icon: "📊", title: "毎日同じ問題", desc: "全国同じ問題で友達と競える。Wordleと同じ方式" },
          { icon: "🔥", title: "連続正解ストリーク", desc: "何日連続で全問正解できるか挑戦しよう" },
        ].map((item, i) => (
